...
func TestResourceInfo(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			got := ResourceInfo(tt.resInfo)
			if got != tt.expected {
				t.Errorf("ResourceInfo error: got=%q expected=%q", got, tt.expected)
			}
		})
	}
}

func TestResourceInfoList(t *testing.T) {
	testCases := []struct {
		name     string
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			got := ResourceInfoList(tt.resInfos)
			if got != tt.expected {
				t.Errorf("ResourceInfoList error: got=%q expected=%q", got, tt.expected)
			}
		})
	}
}
...
func TestZone(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			got := Zone(tt.zone)
			if got != tt.expected {
				t.Errorf("Zone error: got=%q expected=%q", got, tt.expected)
			}
		})
	}
}
...
func TestNodeResourceTopology(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			got := NodeResourceTopology(tt.nrt)
			if got != tt.expected {
				t.Errorf("NodeResourceTopology error: got=%q expected=%q", got, tt.expected)
			}
		})
	}
