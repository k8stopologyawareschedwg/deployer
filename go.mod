...
require (
	...
	github.com/openshift/api v0.0.0-20260326111139-30c2ef7a272e // release 4.22
	github.com/openshift/client-go v0.0.0-20260320040014-4b5fc2cdad98 // release 4.22
